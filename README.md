...
This repository now includes a Capacitor-based Android project while keeping the existing React front end.
...
4. Build the debug APK on Windows with Java 11+:
...
The current Android first release focuses on local-only features, including simulation, history, lab records, settings, and local import/export.
